...
```bash
mkdir -p ~/.clawdock && curl -sL https://raw.githubusercontent.com/Rekonquest/openclaw/main/scripts/shell-helpers/clawdock-helpers.sh -o ~/.clawdock/clawdock-helpers.sh
```
...
See [`ClawDock` Helper README](https://github.com/Rekonquest/openclaw/blob/main/scripts/shell-helpers/README.md) for details.
...
- Image missing: build with [`scripts/sandbox-setup.sh`](https://github.com/Rekonquest/openclaw/blob/main/scripts/sandbox-setup.sh) or set `agents.defaults.sandbox.docker.image`.
