...
- `pnpm build` matters when you run the packaged `openclaw` binary ([`openclaw.mjs`](https://github.com/Rekonquest/openclaw/blob/main/openclaw.mjs)) or use Node to run `dist/`.
