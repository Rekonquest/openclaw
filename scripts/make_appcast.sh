...
FEED_URL=${2:-"https://raw.githubusercontent.com/Rekonquest/openclaw/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/Rekonquest/openclaw/releases/download/v${VERSION}/"}
